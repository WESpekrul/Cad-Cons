...
export default function VeiculoEditar() {
  ...
  useEffect(() => {
    async function getVeiculo(){
      var response = await api.get('/listarveiculo/'+placa);
      ...
      setRntrc(response.data.rntrc);
      setAno_fabricacao(response.data.ano_fabricacao);
      ...
      setFone_fixo(response.data.fone_fixo);
      setCelular(response.data.celular);
      setNum_seguranca(response.data.num_seguranca);
      setDoc_crvl(response.data.doc_crvl);
      setDoc_cvr(response.data.doc_cvr);
      setObservacoes(response.data.observacoes);
      setObservacoes_admin(response.data.observacoes_admin);
      setAceitaram(response.data.aceitaram);
      setDoc_admin(response.data.doc_admin);
      setEncontro_cad(response.data.encontro_cad);
      setEncontro_ace(response.data.encontro_ace);
      setData_vigencia (response.data.data_vigencia);
...
// eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  async function handleSubmit(){
    ...
    if(cnpj !==''&& placa !==''&& categoria !=='' && marca !=='' && senha !==''){
      ...
      const response = await api.put('/editveiculo/',data)
